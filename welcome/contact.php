...
<!-- <div class="fusion-button-wrapper">
    <style type="text/css">.fusion-button.button-2 {border-radius:25px;}</style>
        <a class="fusion-button button-flat fusion-button-default-size button-default button-2 fusion-button-default-span fusion-button-default-type" target="_blank" rel="noopener noreferrer" href="#">
            <span class="fusion-button-text">Send Message</span>
        </a>
</div> -->
